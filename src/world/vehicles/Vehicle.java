...
import world.vehicles.movement.engine.AbstractVehicleMovingEngine;
import world.vehicles.movement.engine.MovingEngine;
import world.vehicles.movement.engine.MovingEngineType;
import world.vehicles.movement.engine.VehicleMovingEngineFactory;
...
public abstract class Vehicle implements Drawable, Serializable {
     ...
     */
    public Vehicle(Point2D location, double speed, MovingEngineType engineType) {
    ...
    public Vehicle(Point2D location, double speed) {
        this(location, speed, MovingEngineType.STANDARD);
    }
    ...
    public synchronized void setLocation(double x, double y) {
        ...
        locationChangedListeners.forEach((o) ->
                o.fire(new Point2D(location.getX(), location.getY()), rotation, transformCondition()));
    }
