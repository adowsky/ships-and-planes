...
import world.passenger.PassengerGenerator;
...
public class FXMLWindowController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            civilianPlane = FXMLLoader.load(getClass().getResource("../fxml/civilian_ship_form.fxml"));
            civilianAirForm = FXMLLoader.load(getClass().getResource("../fxml/civilian_plane_form.fxml"));
            militaryAirForm = FXMLLoader.load(getClass().getResource("../fxml/military_plane_form.fxml"));
    ...
    public void loadFromFile() {
        try (ObjectInputStream in = new ObjectInputStream(new BufferedInputStream(new FileInputStream(SAVE_FILE)))) {
            ...
            SerializeContainer.INSTANCE.clear();
            parser.parse();
            ...
            pButtons.forEach(e -> SerializeContainer.INSTANCE.addToSerialization(e.getModel()));
            Set<VehicleButton> vBtns = finishParsingVehicles(parser.getVehicleButtonsWithName());
            mapPane.getChildren().addAll(vBtns);
            vBtns.forEach(e -> SerializeContainer.INSTANCE.addToSerialization(e.getModel()));
    ...
    public void saveToFile() {
        try (ObjectOutputStream out = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream(SAVE_FILE)))) {
            out.writeObject(SerializeContainer.INSTANCE.getSerializables());
